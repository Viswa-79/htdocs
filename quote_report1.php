 ...
 ?>
            ...
            <!-- <h1> <input type="text" id="myInput" onKeyUp="myFunction()" placeholder="Search for Anything..." style="width:100%;">
              ...
              <div id="mydiv" class="card ">
                <div style=" text-align:center;padding:15px">
                      <h1 class="btn btn-warning" style="font-size:20px">Quotation Report</h1>
                     </div>
    ...
    <table id="ConvertTable" class="table table-bordered table-hover colorful-table">
        <thead style="text-align:center;font-weight:bold">
             ...
             $sql4 = " SELECT *,w.size as size,q.id as idn,e.name as name FROM quote q left join quote1 w on q.id=w.cid left join partymaster e on q.partyname=e.id left join inspect_type m on w.inspect=m.id where '$fromdate' and '$todate' $rr order by q.id asc";
            ...
            ?>
               ...
               <td style="text-align:center"><a href="quote_upd.php?cid=<?php echo base64_encode($id);?>" target="blank" ><?php echo $wz1['quote_no']; ?></a></td>    
               <td nowrap><?php echo date('d-m-Y',strtotime($wz1['date'])); ?></td>  
               <td><div style="width:200px;"><?php echo $wz1['name'];echo",&nbsp; "; echo $wz1['city']; ?></div></td>      
               <td style="text-align:center"><div ><?php echo $wz1['styleno']; ?></div></td> 
               <td><div style="width:250px;"><?php echo $wz1['type']; ?></div></td>      
               <td style="text-align:center"><div ><?php echo $wz1['size']; ?></div></td>      
               <td style="text-align:right"><?php echo $wz1['quantity']; ?></td>          
...
<a href="quote_report.php" class="btn btn-primary"><i class="ti ti-arrow-left me-sm-1 me-0"></i>Back</a>

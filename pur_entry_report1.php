  ...
  ?>
            ...
            <div  class="container-xxl flex-grow-1 container-p-y">
              <div id="mydiv" class="card mb-4 ">
                ...
                <h1 class="btn btn-outline-primary" style="font-size:20px">Purchase Entry Report</h1>
                     </div>
    ...
    <table id="ConvertTable" class="table table-bordered table-hover colorful-table">
        <thead style="text-align:center;font-weight:bold">
                ...
                <tbody>
                 ...
                 $sno=1;
                $sql4 = " SELECT *,s.id as idn FROM purchaseentry s left join purchaseentry1 s1 on s.id=s1.cid left join asset_master c on s1.productname=c.id left join partymaster d on s.supplier=d.id where date between '$fromdate' and '$todate' order by receipt asc";
               ...
               <td style="text-align:center"><?php echo $wz1['receipt']; ?></td>      

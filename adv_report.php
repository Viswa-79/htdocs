          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card-header d-flex align-items-center justify-content-between">
                      ...
                      <button class="btn btn-label-primary">Advance Salary Report </button>
                     
                    </div>  <br>         
                                <div class="card mb-2 mt-2">
                   
                      <form class="card-body" action="adv_report1.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row g-3">
                          ...
                          <div class="col-md-3">
                            ...
                            <select name="staffname" id="staffname" class="select2 form-select" >

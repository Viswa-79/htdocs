...
const myFunction = () => {
 ...
 ?>
          ...
          <button class="btn btn-label-warning waves-effect">General Expense  Report</button>
        ...
        <thead style="text-align:center;font-weight:bold">
                  ...
                  <th  style="text-align:center" nowrap><b>Rec&nbsp;No</b></th>                
                  <th  style="text-align:center" nowrap><b>Date</b></th>                
                  <th  style="text-align:center" nowrap><b>Party&nbsp;Name</b></th>                
                  <th  style="text-align:center"nowrap><b>Expense</b></th>
                  <th  style="text-align:center"nowrap><b>Description</b></th>
                  <th  style="text-align:center" nowrap><b>From Date</b></th>
				  <th  style="text-align:center" nowrap><b>To Date</b></th>
          <th  style="text-align:center" nowrap><b>Amount</b></th>
            ...
            $type=$_REQUEST['type'];
                    ...
                    $aa=array('h.supplier'=>$staffname,'h1.exp_type'=>$type);
                    $aa=array_filter($aa);
                ...
                $clr='';
             $tott=0;
         $sql4 = "SELECT *,h.id as id From  general_exp  h left join  general_exp1 h1 on h.id=h1.cid left join  expense_party e  on h.supplier=e.id left join expense d on h1.exp_type=d.id   where h.date between '$fromdate' and '$todate' $rr order by h.id asc";
    ...
    $result4 = mysqli_query($conn, $sql4);
            ...
            ?>
               ...
               <td style="text-align:center"><?php echo $wz1['rec_no']; ?></td>           
               <td style="text-align:center" nowrap><?php echo date('d-m-Y',strtotime($wz1['date']));?></td>           
               <td style="text-align:center" nowrap><?php echo $wz1['name']; ?></td>           
               <td style="text-align:center" nowrap><?php echo $wz1['expense_name']; ?></td>           
               <td style="text-align:center" nowrap><?php echo $wz1['remark']; ?></td>           

               <td style="text-align:center"  nowrap><?php echo date('d-m-Y',strtotime($wz1['from_date']));?></td>           
               <td style="text-align:center"  nowrap><?php echo date('d-m-Y',strtotime($wz1['to_date']));?></td>           
...
<tr style="font-weight:bold;font-size:17px">
             <td colspan="8" style="text-align:right;"><?php echo 'TOTAL'; ?></td>
...
<a href="gen_exp_report.php" class="btn btn-primary mt-4"><i class="ti ti-arrow-left me-sm-1 me-0"></i>Back</a>

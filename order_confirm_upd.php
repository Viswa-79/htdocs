...
<?php
  ...
  <a href="uploads/<?php echo $wz1['doc4']; ?>" target="blank"><?php echo $wz1['doc4']; ?></a>                                           
                          ...
                          <div class="col-md-4">
                            <label class="form-label" for="collapsible-phone">Shipment Port</label>
                            <input
                              type="text"
                              id="shipport"
                              name="shipport"
                              value="<?php echo $row['shipport']; ?>"
                              class="form-control phone-mask"
                              placeholder="John Doe"
                              aria-label="658 799 8941" />
                          </div>
...
if (isset($_POST['submit'])) {
  ...
  $inspection = $_POST['inspection'];
    ...
    $sql1 = "UPDATE order1 SET ord_no='$ord_no',date='$date',partyname='$partyname',ordertype='$ordertype',length='$length',
    Destination='$Destination',payment='$payment',tolerance='$tolerance',currency='$currency',shipment='$shipment',loads='$loads',shipterm='$shipterm',shipport='$shipport',contact='$contact',
  ...
  foreach ($_POST['pono'] as $key => $val) {
    ...
    $totamt = $_POST['totamt'][$key];
     ...
     echo $sql2 = "UPDATE order2 SET pono='$pono',itemno='$itemno',itemdesc='$itemdesc',label='$label',print='$print',quality='$quality',
      clwidth='$clwidth',size='$size',quantity='$quantity',unit='$unit',price='$price',totamt='$totamt' WHERE id='$rid' ";
      $result2 = mysqli_query($conn, $sql2);

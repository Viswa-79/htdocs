          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card-header d-flex align-items-center justify-content-between mt-4">
                      ...
                      <button class="btn btn-warning">Attendance Generate </button>
                      <a class="btn btn-outline-warning" href="attendance_list.php">
                        <i class="ti ti-eye me-sm-1 me-0"></i>View Attendance</a>
                     
                    </div>  <br>         
                                <div class="card mb-2 mt-2">
                   
                      <form class="card-body" action="attendance_report1.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row g-3">
                          ...
                          <!-- <div class="col-md-3">
                            ...
                            <select
                              ...
                              <option value="2">IN / OUT Report</option>
                          </select>
                          </div> -->
                          </div>

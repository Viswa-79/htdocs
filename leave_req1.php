      ...
      <div class="layout-container">
        ...
        <div class="layout-page">
         ...
         <?php include "header.php"; ?>
          ...
          <h3> <button class="btn btn-label-primary"> Leave Request</button></h3>
...
&nbsp;
  ...
  <path d="M11 1.5v1h3.5a.5.5 0 0 1 0 1h-.538l-.853 10.66A2 2 0 0 1 11.115 16h-6.23a2 2 0 0 1-1.994-1.84L2.038 3.5H1.5a.5.5 0 0 1 0-1H5v-1A1.5 1.5 0 0 1 6.5 0h3A1.5 1.5 0 0 1 11 1.5m-5 0v1h4v-1a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 0-.5.5M4.5 5.029l.5 8.5a.5.5 0 1 0 .998-.06l-.5-8.5a.5.5 0 1 0-.998.06m6.53-.528a.5.5 0 0 0-.528.47l-.5 8.5a.5.5 0 0 0 .998.058l.5-8.5a.5.5 0 0 0-.47-.528M8 4.5a.5.5 0 0 0-.5.5v8.5a.5.5 0 0 0 1 0V5a.5.5 0 0 0-.5-.5"/>
      ...
      <?php 
			echo		$sql2 = "SELECT * FROM employee where id=$user_id";
                    $result2 = mysqli_query($conn, $sql2);
                    $rw2 = mysqli_fetch_array($result2);
                   echo $allowleave=$rw2['allowleave'];
					?>
...
const data = JSON.parse(r);
   ...
   $('#monthleave').val(data.monthleave);             
    ...
    xmlhttp.open("GET","ajax/get_leavedays.php?id="+value,true);
    xmlhttp.send();
  }
}
</script>
...
alert(r);
    ...
    <!-- Page JS -->
    <script src="../../assets/js/extended-ui-sweetalert2.js"></script><?php include "config.php";include "head.php" ?><?php include "session.php";?>

    ...
    <div class="layout-wrapper layout-content-navbar">
      <div class="layout-container">
        ...
        <div class="layout-page">
         ...
         <h3> <button class="btn btn-primary">Manage Leave Type</button></h3>
                 ...
                 <div class="card">
                  ...
                  <div  class="card-datatable table-responsive">
                    <table id="myTable" class="table table-hover display">
                      ...
                      <tbody>
                      <?php
                       $sq ="SELECT * from permission_access WHERE usr_id ='$uid' and names=6";
                  ...
                  ?>
                     <input type="text" hidden name="id[]" id="id<?php echo $sno; ?>" value="<?php echo $rows['id'];?>">
                      ...
                      <td  style="padding-top:15px;padding-bottom:15px;" nowrap><?php echo $rows['leavename'];?></td>
                      <td  style="padding-top:15px;padding-bottom:15px;" nowrap><?php echo $rows['days'];?></td>
                      <td  style="padding-top:15px;padding-bottom:15px;" nowrap><?php echo $clr;?></td>
               ...
               <div class="col-xl-4 col-lg-6 col-md-6">
                 <div class="card">
                   <div class="card-body">
                    ...
                    <h5 id="offcanvasAddUserLabel" class="offcanvas-title"><span id="form-title">Create/Edit</span>&nbsp;Leave Type</h5>
                    <button
                      type="button"
...
<br>
                      ...
                      <div class="mb-3">
                      <label class="form-label" for="add-user-fullname">Leave Type</label>
                        <input
                          type="text"
                          class="form-control"
                          id="leavename"
                      ...
                      <div class="mb-3">
                      <label class="form-label" for="add-user-fullname">Days</label>
                        <input
                          type="number"
                          class="form-control"
                          id="days"
                      ...
                      <div class="mb-3">
                      <label class="form-label" for="add-user-fullname">Period</label>
                      <select id="period" name="period" class="select form-select" required>
...
<span id="wrong_pass_alert"></span>
<button disabled type="submit" class="btn btn-primary me-sm-3 me-1 data-submit"
id="create" onclick="wrong_pass_alert()" name="submit">Submit</button> 
<?php } ?>
...
if($id==""){
 ...
 $sql="insert into leave_type (leavename,days,period)values('$leavename','$days','$period')"; 
$result1=mysqli_query($conn, $sql);


}else{
  $sql="UPDATE leave_type SET leavename='$leavename',days='$days',period='$period'  WHERE id='$id'";
...
if ($result1) {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      window.location.href = "leavetype.php"; // Corrected line
    }
  });
</script>';
} 
...
function getdia(id) {
  ...
  if (id != "") {
   ...
   $('#period').val(data.period);             
    ...
    xmlhttp.open("GET","ajax/getleave.php?id="+user_id,true);
    xmlhttp.send();
  }
}
</script>

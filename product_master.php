          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card-header d-flex align-items-center justify-content-between">
                      <button class="btn btn-label-success">PRODUCT&nbsp;LIST</button><br>
                     ...
                     <div >
                            <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                              <a type="button"  tabindex="0" onclick="addParty();" aria-controls="DataTables_Table_0"
            ...
            <div class="modal fade" id="largeModal" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog modal-lg" role="document">
                          ...
                          aria-label="John Doe" />
                            ...
                            <select id="productgroup" class="select form-select" name="productgroup" data-allow-clear="true" required >
				...
				$sql1 = "SELECT * FROM product_group order by pro_grp_name asc";
					...
					<?php } ?>
								     ...
								     <div class="col-md-8">
                                <label class="form-label" for="formtabs-country">Product&nbsp;Name&nbsp;<span style="color:red;">*</span></label>
                                <input
                              type="text"
                              class="form-control"
                              id="productname"
                              name="productname" required/>
                                 ...
                                 <div class="col-md-4">
                                <label class="form-label" for="formtabs-country">Product&nbsp;Code&nbsp;</label>
                              <input
                              type="text"
                              class="form-control"
                              id="productcode"
                              name="productcode" />
								 ...
								 <div class="col-md-4">
                                  ...
                                  <label class="form-label" for="form-repeater-1-4">Pcs/Kg</label>
                                  <input class="form-control" type="text" name="pcs" id="pcs" />
                                </div>
								
									  <div class="col-md-4">
                                  <label for="emailLarge" class="form-label">Unit&nbsp;<span style="color:red;">*</span></label>
                                  <select name="unit" id="unit" class="select form-select" required>
                                <option value="">Select</option>
							<?php 
...
if($id==""){
 $sql3="insert into product_master (productgroup,hsn,productcode,productname,supplier,size,unit,specification,decription,gstno,price,pcs) 
 values('$productgroup','$hsn','$productcode','$productname','$supplier','$size','$unit','$specification','$decription','$gstno','$price','$pcs')"; 
$res1=mysqli_query($conn, $sql3);
}else{
$sql2="UPDATE product_master SET productgroup='$productgroup',hsn='$hsn',productcode='$productcode',productname='$productname',price='$price',pcs='$pcs',supplier='$supplier',size='$size',unit='$unit',specification='$specification',decription='$decription',gstno='$gstno' WHERE id='$id'"; 

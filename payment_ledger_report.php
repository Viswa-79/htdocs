          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card-header d-flex align-items-center justify-content-between">
                      ...
                      <button class="btn btn-warning">Payment Ledger Report </button>
                     
                    </div>  <br>         
                                <div class="card mb-2 mt-2">
                   
                      <form class="card-body" action="payment_ledger_report1.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row g-3">
                          ...
                          <div class="col-md-3">
                            <label class="form-label" for="collapsible-fullname">Type&nbsp;<span style="color:red;">*</span></label>
                              <select id="type" name="type" class="form-select " required onchange="get_party(this.value);" autofocus>
...
document.getElementById('partyname').innerHTML = r;
    ...
    xmlhttp.open("GET","ajax/get_partyname.php?id="+value,true);
    xmlhttp.send();
  }
}
</script>

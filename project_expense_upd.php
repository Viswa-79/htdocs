        ...
        <div class="layout-page">
		 ...
		 ?>               
                      ...
                      <form  action="" method="post" enctype="multipart/form-data" autocomplete="off">
                        ...
                        <!-- Personal Info -->
                        <?php
                              $sql4 = " SELECT * FROM project_expense WHERE id='$sid'";
                        ...
                        <div class="row mb-6">
                          ...
                          <div class="col-md-2">
                            ...
                            <select name="pono" id="pono" class="select form-select" data-allow-clear="true" >
                                <option value="">Select</option>
							<?php 
					$sql = "SELECT * FROM  where   order by name asc";
                    $result = mysqli_query($conn, $sql);
                    while($rw = mysqli_fetch_array($result))
					{ ?>
                     <option <?php if($rw['id']==$wz1['factoryname']){ ?> Selected <?php } ?> value="<?php echo $rw['id'];?>"><?php echo $rw['name'];?></option>
                    <?php } ?>
                          ...
                          <div class="col-md-2">
                            ...
                            <select name="factoryname" id="factoryname" class="select form-select" data-allow-clear="true" >
                                <option value="">Select</option>
							<?php 
					$sql = "SELECT * FROM assignment where   order by name asc";
                    $result = mysqli_query($conn, $sql);
                    while($rw = mysqli_fetch_array($result))
					{ ?>
                     <option <?php if($rw['id']==$wz1['factoryname']){ ?> Selected <?php } ?> value="<?php echo $rw['id'];?>"><?php echo $rw['name'];?></option>
                ...
                $city=$rw11['city'];
                             ...
                             <input type="text" hidden name="rid[]" id="rid" value="<?php echo $rw['id'];?>"> 
                                ...
                                <td  style="padding: 0.3rem;text-align:center">
                                 ...
                                 <select style="width:200px" name="factoryname[]" id="factoryname<?php echo $i;?>" class="select form-select" data-allow-clear="true">
                                <option value="">Select</option>
							<?php 

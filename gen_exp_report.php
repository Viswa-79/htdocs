          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card-header d-flex align-items-center justify-content-between">
                      ...
                      <button class="btn btn-warning">General Expense Report </button>
                     
                    </div>  <br>         
                                <div class="card mb-2 mt-2">
                   
                      <form class="card-body" action="gen_exp_report1.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row g-3">
                          ...
                          <div class="col-md-3">
                            ...
                            <select name="partyname" id="partyname" class="select form-select" style="text-transform:uppercase" >
                            <option value="">Select All</option>
                             <?php 
			             	$sql11 = "SELECT * FROM expense_party   order by name asc ";
                          ...
                          <div class="col-md-3">
                            <label class="form-label" for="collapsible-fullname">Expense&nbsp;Type<span style="color:red;"></span></label>
                            <select name="type" id="type" class="select form-select" >
                            <option value="">Select All</option>
                             <?php 
			             	$sql11 = "SELECT * FROM expense  order by id asc ";
                                $result11 = mysqli_query($conn, $sql11);
                                while($rw11 = mysqli_fetch_array($result11))
			             	{ ?>
                                     <option value="<?php echo $rw11['id'];?>"><?php echo $rw11['expense_name'];?>
			             		 </option>
			             	<?php } ?>
                                        </select>
                                      </div>

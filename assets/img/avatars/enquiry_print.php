...
?>
 ...
 <span class="style5"><strong><u>Regarding Inquiry No. - <?php echo $so['partyref'];?></strong> </span></td>
...
$sql = " SELECT * FROM enquiry1 e1 left join item_master im on e1.itemno=im.id WHERE cid='$sid'";
$result =mysqli_query($conn, $sql);
 ...
 <td height="100" style="border-right:1px solid black;"> <div align="left" style="margin-left:2%;"><strong>
  ...
  <tr style="border-bottom:1px solid black;" >
    <td width="300"  style=" border:1px solid #000000; "><div align="left">
      ...
      <td  style="border-right:1px solid black;" ><div align="left" style="margin-left:2%;"><?php echo $rw['quality'];?></br></div></td>
...
<?php /*?><table width="878"  align="center" style="border-collapse:collapse; border:none;">
 ...
 <span class="style5">Cartoon Box Size </span></td>

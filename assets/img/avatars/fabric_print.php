...
$sid=base64_decode($_GET['cid']);
  ...
  $sql = " SELECT * FROM fabric WHERE id='$sid'";
...
<b>FABRIC PLANNING</BR></BR>
	  Order No : OMT/<?php echo $so1['orderno'];?>&nbsp;&nbsp;
	  Po No : <?php echo $so1['pono'];?><br />Ref No : <?php echo $so['ref'];?><br />
&nbsp;&nbsp;Follow Up : <?php echo $so['follow'];?><br />
&nbsp;&nbsp;Delivery Date : <?php echo $so['deliverydt'];?>&nbsp;&nbsp;
</b>
...
$sql2 = " SELECT * FROM fabric1 WHERE cid='$sid'";
...
while($b3=mysqli_fetch_object($result2))
  ...
  <tr style="border-bottom:1px solid black;" >
      ...
      <td height="100" style="border-right:1px solid black;vertical-align:center;"> <div align="left" style="margin-left:2%;"><strong>Item no:<?php echo $b3->itemno;?>/<?php echo $b3->pono;?></strong></br><strong>Description :</strong><?php echo $b3->itemdesc;?></br>
	<?php if($b3->print!='')
	{ ?>  
...
<table  width="800" align="center" style=" border-top:1px solid #000000; border-collapse: collapse;">
 ...
 <td style="border:none; border-right:none;" >
  <p align="justify"><strong>Remarks :</strong><br />
 <span class="style5"><?php echo $so['remarks'];?></span>
   ...
   <tr>
 <td style="border:none; border-right:none;" >
  <p align="justify"><strong>Prepared By :</strong><br />
 <span class="style5"><?php echo $so['preparedby'];?></span>
 ...
 <td style="border:none; border-right:none;" >
  <p align="justify"><br />
 <span class="style5"><?php echo $so['instruction'];?></span><br />
 <br />

...
<html
 ...
 <div class="card">
               <div 
                      ...
                      <h5 class="card-title mb-sm-0 me-2" >Budget&nbsp;Entry&nbsp;List</h5>
               ...
               &nbsp;  <a class="btn btn-primary add-new " tabindex="0" href="budget_entry.php"
                 type="button" >
                ...
                <div class="card-body">
                  <div class="card-datatable table-responsive">
                    <table class="table table-hover">
                      ...
                      <tbody>
                        <?php
                         ...
                         $sql = " SELECT * FROM budget_entry  ORDER by id desc" ;
                    ...
                    <td><div align="center"><?php echo $sno; ?></div></td>                          
                     ...
                     <td><?php echo $rows['porate']; ?></td>                          
                                                
                     <td>
                          <a href="budget_entry_upd.php?cid=<?php echo base64_encode($rows['id']);?>"
                           type="button" 
                          ...
                          <a  href="ajax/delbudget_entry.php?cid=<?php echo base64_encode($rows['id']);?>" type="button" data-bs-toggle="offcanvas"
                          data-bs-target="#offcanvasEcommerceCustomer"
                          class="btn btn-outline-danger"
                          id="del<?php echo $sno;?>" 
                          onclick="delbudget_entry(del<?php echo $sno;?>.id);" >
...
if(data.sts == 'ok'){
  ...
  window.location='budget_entrylist.php';

                   
}
      }
    };
    xmlhttp.open("GET","ajax/delbudget_entry.php?id="+cid,true);
    xmlhttp.send();
  }
}
}

          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card-header d-flex align-items-center justify-content-between">
                      ...
                      <button class="btn btn-label-primary">Inspection Report </button>
                     
                    </div>  <br>         
                                <div class="card mb-2 mt-2">
                   
                      <form class="card-body" action="inspect_report1.php" method="post" enctype="multipart/form-data">
					...
					{ ?>
                         <option value="<?php echo $rw['name'];?>"><?php echo $rw['name'];?>
						 </option>
					<?php } ?>
                              </select>
                          </div>

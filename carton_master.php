      ...
      <div class="layout-container">
        ...
        <div class="layout-page">
         ...
         <?php include "header.php"; ?>
          ...
          <button class="btn btn-primary">Carton Master</button>
          <?php
           $sq ="SELECT * from permission_access WHERE usr_id ='$uid' and names=14";
          ...
          <?php } else { ?>
          <button class="btn btn-primary float-end btn-group" style="color:white" disabled data-bs-toggle="offcanvas" data-bs-target="#offcanvasAddUser" tabindex="0" onclick="addCurrency();" ><i style="color: white;" class="ti ti-plus me-0 me-sm-1 ti-xs"></i>Add New</button>
                    <?php } ?>
                    ...
                    <table id="myTable" class="table table-hover display">
                      <thead>
                        <tr>
                          ...
                          <th nowrap>Specifications</th>
                          <th nowrap>Result</th>
                          <th nowrap>Observations</th>
                        <th >Action</th>
                        </tr>
                      </thead>
                      <tbody>
                      ...
                      $sql = " SELECT * FROM carton_master order by id asc";
  ...
  <path d="M11 1.5v1h3.5a.5.5 0 0 1 0 1h-.538l-.853 10.66A2 2 0 0 1 11.115 16h-6.23a2 2 0 0 1-1.994-1.84L2.038 3.5H1.5a.5.5 0 0 1 0-1H5v-1A1.5 1.5 0 0 1 6.5 0h3A1.5 1.5 0 0 1 11 1.5m-5 0v1h4v-1a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 0-.5.5M4.5 5.029l.5 8.5a.5.5 0 1 0 .998-.06l-.5-8.5a.5.5 0 1 0-.998.06m6.53-.528a.5.5 0 0 0-.528.47l-.5 8.5a.5.5 0 0 0 .998.058l.5-8.5a.5.5 0 0 0-.47-.528M8 4.5a.5.5 0 0 0-.5.5v8.5a.5.5 0 0 0 1 0V5a.5.5 0 0 0-.5-.5"/>
               ...
               <div
                  ...
                  <div class="offcanvas-header">
                    <h5 id="offcanvasAddUserLabel" class="offcanvas-title"><span id="form-title">Add</span> Carton Details</h5>
                      ...
                      <label class="form-label" for="add-user-fullname" >Specifications</label>

                      <input name="specs" id="specs" class="form-control" autofocus required>
                      ...
                      <div class="mb-3">
                      <label class="form-label" for="add-user-fullname">Result</label>
                        <select
                          type="text" class="form-select" id="result" name="result" >
                      ...
                      <div class="mb-3">
                      <label class="form-label" for="add-user-fullname">Observations</label>
                        <input
                          type="text"
                          class="form-control"
                          id="observation"
...
if($id==""){
  ...
  $sql="insert into carton_master (specs,result,observation)values('$specs','$result','$observation')"; 
$result1=mysqli_query($conn, $sql);


}else{
  $sql="UPDATE carton_master SET specs='$specs',result='$result',observation='$observation' WHERE id='$id'";
...
if ($result1) {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      window.location.href = "carton_master.php"; // Corrected line
    }
  });
</script>';
} 
        ...
        if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
          ...
          if (data.sts == 'ok') {
            ...
            Swal.fire('Deleted!', 'Your file has been deleted.', 'success').then(() => {
              window.location = 'carton_master.php';
            });
          }
        }
      };
      xmlhttp.open("GET", "ajax/del_carton.php?id=" + user_id, true);
      xmlhttp.send();
    }
  });
}
...
if(data.sts == 'ok'){
   ...
   $('#observation').val(data.observation);             
    ...
    xmlhttp.open("GET","ajax/get_carton.php?id="+user_id,true);
    xmlhttp.send();
  }
}
</script>

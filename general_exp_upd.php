                ...
                <form class="card-body"action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="bs-stepper-content">
                      <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <?php
                              $sql4 = " SELECT * FROM general_exp WHERE id='$sid'";
                    ...
                    <?php } ?>                                        
                        ...
                        <div class="table-responsive">
                            <table class="table table-border  table-hover mt-2">
                              ...
                              <?php
                        $sno=1; $i=0;
                              $sql4 = " SELECT * FROM general_exp1 Where cid='$sid'";
                              $result4 = mysqli_query($conn, $sql4);
                ...
                <select name="exp_type[]"  id="exp_type<?php echo $i;?>" class="select form-select" onchange="get_items1(this.id,this.value);">
                            ...
                            $result = mysqli_query($conn, $sql);
                             while($rw1 = mysqli_fetch_array($result))
					                  { ?>
                        <option <?php if($rw1['id']==$rw['exp_type']){ ?> Selected <?php } ?> value="<?php echo $rw1['id'];?>"><?php echo $rw1['expense_name'];?></option>
                        <?php } ?>
...
<input type="text" hidden class="form-control form-control-lg" name="rc[]" id="rc" value="<?php echo $i;?>">
              ...
              <div class="mb-0"><hr></div>
                          ...
                          <a class="btn btn-label-dark btn-prev" href="general_exp_list.php">
...
if (isset($_POST['submit'])) {
  ...
  $remarks = $_POST['remarks'];
   ...
   $sql = "UPDATE general_exp SET rec_no='$rec_no',date='$date',supplier='$supplier',remarks='$remarks' where id='$cid'";
    $result = mysqli_query($conn, $sql);
  ...
  foreach ($_POST['exp_type'] as $key => $val) {
    ...
    $amount = $_POST['amount'][$key];
     ...
     $sql1 = "UPDATE general_exp1 SET exp_type='$exp_type', remark='$remark',from_date='$from_date',to_date='$to_date',amount='$amount' where id='$rid'";
  ...
  if ($result1) {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        window.location.href = "general_exp_list.php"; // Corrected line
      }
    });
  </script>';
  } 

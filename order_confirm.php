              ...
              <div class="row">
                 ...
                 <option value="Box">No</option>
					...
					<?php } ?>
                          ...
                          <div class="col-md-4">
                            ...
                            <select name="sample" id="sample" class="select2 form-select" data-allow-clear="true">
                                <option value="">Select</option>
                ...
                <td style="padding: 0.3rem">
                 <input
                                   ...
                                   <td style="padding: 0.3rem">
                                   <select name="itemno[]" style="width:100px" id="itemno<?php echo $i;?>" class="select form-select" onchange="get_item_details(this.id,this.value);" required >
                                <option value="">Select</option>
							<?php 
...
if (isset($_POST['submit'])) {
  ...
  $sample = $_POST['sample'];
    ...
    $sql = "INSERT into order1 (ord_no,enq_no,date,partyname,ordertype,length,Destination,payment,tolerance,currency,shipterm,shipment,loads,shipport,contact,title,agent,remark,notes,sample) 
 values ('$ord_no','$enq_no','$date','$partyname','$ordertype','$length','$Destination','$payment','$tolerance','$currency','$shipterm','$shipment','$loads','$shipport','$contact','$title','$agent','$remark','$notes','$sample')";
    $result = mysqli_query($conn, $sql);
  
    $sq="select max(id) as id from order1";

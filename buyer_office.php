  ...
  <body>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card-header d-flex align-items-center justify-content-between">
                      <button class="btn btn-label-success">BUYER&nbsp;LIST</button><br>
              ...
              <div class="card mt-4">
                ...
                <table id="myTable" class="table table-hover display">
                  ...
                  $sql = " SELECT * FROM buyeroffice order by name asc";
                        ...
                        <div class="modal-dialog modal-lg" role="document">
                          ...
                          <form action="" method="post" autocomplete="off">
                            <div class="modal-header">
                              <h5 class="modal-title" id="exampleModalLabel3"><span id="form-title">Add</span> Buyer Details</h5>
    ...
    <option value="Zimbabwe">Zimbabwe</option>
                                ...
                                <div class="col-md-4">
                                  ...
                                  <select class="select form-select" name="currency" id="currency" data-allow-clear="true" >
...
if($id==""){
  $sql="insert into buyeroffice (party_group,name,title,cpname,mobileno,telephone,email,address,country,state,city,pincode,gstno,currency) 
 values('$party_group','$name','$title','$cpname','$mobileno','$telephone','$email','$address','$country','$state','$city','$pincode','$gstno','$currency')"; 
$result1=mysqli_query($conn, $sql);
}else{
  $sql="UPDATE buyeroffice SET party_group='$party_group',name='$name',title='$title',cpname='$cpname',mobileno='$mobileno',telephone='$telephone',email='$email',address='$address',country='$country',state='$state',city='$city',pincode='$pincode',gstno='$gstno',currency='$currency' WHERE id='$id'"; 
  $result2=mysqli_query($conn, $sql);
}
if($result1) { 
 
  echo "<script>alert('Buyer Registered successfully');window.location='buyer_office.php';</script>";
 
}
else if($result2) { 
  echo "<script>alert('Buyer Updated Successfully');window.location='buyer_office.php';</script>";
...
if(data.sts == 'ok'){
    ...
    xmlhttp.open("GET","ajax/getBuyer.php?id="+user_id,true);
    xmlhttp.send();
  }
}
</script>
...
if(data.sts == 'ok'){
  ...
  window.location='buyer_office.php';

                   
}
      }
    };
    xmlhttp.open("GET","ajax/delBuyer.php?id="+user_id,true);
    xmlhttp.send();
  }
}
}

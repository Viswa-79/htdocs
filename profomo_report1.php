 ...
 ?>
            ...
            <!-- <h1> <input type="text" id="myInput" onKeyUp="myFunction()" placeholder="Search for Anything..." style="width:100%;">
              ...
              <div id="mydiv" class="card ">
                <div style=" text-align:center;padding:15px">
                      <h1 class="btn btn-warning" style="font-size:20px">Proforma Report</h1>
                     </div>
                ...
                <table  id="ConvertTable" class=" table table-bordered " style="border-collapse:collapse" border="1" width="90%">
                <thead > -->
    ...
    <table id="ConvertTable" class="table table-bordered table-hover colorful-table">
        <thead style="text-align:center;font-weight:bold">
                ...
                $tamnt=0; $tman=0; $totamt=0;
             $sql4 = " SELECT *,q.id as idn,e.name as name,m.name as names FROM profomo q left join profomo1 w on q.id=w.cid left join partymaster e on q.partyname=e.id left join assignment m on w.factoryname=m.id where date between '$fromdate' and '$todate' $rr order by q.id asc";
            ...
            ?>
               ...
               <td style="text-align:center"><a href="profomo_upd.php?cid=<?php echo base64_encode($id);?>" target="blank" ><?php echo $wz1['profomo']; ?></a></td>    
               ...
               <td style="text-align:center"><div ><?php echo $wz1['sac']; ?></div></td>      
               <td style="text-align:center"><?php echo $wz1['manday']; ?></td>          
               <td style="text-align:center"><?php echo $wz1['charges']; ?></td>          
               <td style="text-align:right"><?php echo $wz1['totamnt']; ?></td>          
             ...
             <tr>
                ...
                <td colspan="6" style="text-align:right"><b><?php echo "NET TOTAL"; ?></b></td> 
                <td style="text-align:center"><b><?php echo $tman; ?></b></td> 
                <td style="text-align:center"><b><?php echo ""; ?></b></td> 
                <td style="text-align:right"><b><?php echo number_format((float)$tamnt,2, '.', ''); ?></b></td> 
...
<a href="profomo_report.php" class="btn btn-primary"><i class="ti ti-arrow-left me-sm-1 me-0"></i>Back</a>

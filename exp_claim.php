      ...
      <div class="layout-container">
        ...
        <div class="layout-page">
         ...
         <?php include "header.php"; ?>
          ...
          <h3> <button class="btn btn-label-primary">General Expense </button></h3>
                     
                    
                                  <!-- <a class="btn btn-primary float-end btn-group" style="color:white"  data-bs-toggle="modal" data-bs-target="#editUser" tabindex="0"   onclick="addCurrency();"><i style="color: white;" class="ti ti-plus me-0 me-sm-1 ti-xs"></i>Apply Claim</a> -->
                                  <a class="btn btn-primary float-end btn-group" style="color:white"  href="emp_exp_claim.php" ><i style="color: white;" class="ti ti-plus me-0 me-sm-1 ti-xs"></i>Add Entry</a>
</div>         
   <!-- Teams Cards -->
   <div class=" row g-4">
   ...
   <div class="col-xl-12 col-lg-6 col-md-6">
                 <div class="card">
                  ...
                  <div  class="card-datatable table-responsive">
                    ...
                    $sql = " SELECT *,a.id as id,a.status as status,a.date as date FROM  exp_claim a left join expense b on a.exp_type=b.id left join employee c on a.staff=c.id where a.staff='$user_id' and a.u_status='1' and a.g_status!='1' order by a.id desc";
                  ...
                  ?>
                     <input type="text" hidden name="id[]" id="id<?php echo $sno; ?>" value="<?php echo $rows['id'];?>">
                      ...
                      <td nowrap><?php echo $rows['expense_name'];?></td>
                      <td nowrap style="text-align:center"><?php echo date ('d M Y ',strtotime($rows['date'])); ?> </td>
                      
                      <td align="center"><?php echo $rows['applydate'];?></td>
...
$move = move_uploaded_file($p_tmp1, $path);				
  ...
  $sql="insert into exp_claim (staff,exp_type,date,applydate,amount,remarks,doc)values('$staff','$exp_type','$date','$applydate','$amount','$remarks','$p1')"; 
...
if ($result1) {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      window.location.href = "exp_claim.php"; // Corrected line
    }
  });
</script>';
} 
  ...
  Swal.fire({
    title: "Update!",
    text: " Claim Request has been Updated successfully.",
    icon: "success",
    confirmButtonText: "OK"

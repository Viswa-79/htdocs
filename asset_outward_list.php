          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card-header d-flex align-items-center justify-content-between">
                      <button class="btn btn-success">Asset Outward LIST</button><br>
                      ...
                      <div >
                            <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                              <a type="button" href="asset_outward.php" class="btn btn-primary"> <i class="ti ti-plus me-0 me-sm-1 ti-xs"></i> Add New
                  ...
                  <div class="card-datatable table-responsive">
                    <table id="myTable" class="table table-hover display">
                      ...
                      <?php
                         ...
                         $sql = " SELECT *,b.id as id FROM asset_outward b left join partymaster c on b.supplier=c.id ORDER by b.id desc" ;
                     ...
                     <td><?php echo $rows['name'];?></td>                          
                          ...
                          <a href="asset_outward_upd.php?cid=<?php echo base64_encode($rows['id']);?>" 
                          ...
                          <a href="services_print.php?cid=<?php echo base64_encode($rows['id']);?>" 
        ...
        if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
          ...
          if (data.sts == 'ok') {
            ...
            Swal.fire('Deleted!', 'Your file has been deleted.', 'success').then(() => {
              window.location = 'asset_outward_list.php';
            });
          }
        }
      };
      xmlhttp.open("GET", "ajax/del_asset_outward.php?id=" + user_id, true);
      xmlhttp.send();
    }
  });
}

          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card-header d-flex align-items-center justify-content-between">
                      <button class="btn btn-success"> Damage Asset List</button><br>
                     ...
                     <div >
                            ...
                            <div class="btn-group" role="group" aria-label="Button group with nested dropdown"> <a
                             ...
                             href="ass_assign_list.php"
                                  aria-haspopup="true"
                                  aria-expanded="false">Asset Assign list
                ...
                <div class="card-body">
                  <div class="card-datatable table-responsive">
                    ...
                    <input type="text" hidden name="cid[]" id="cid<?php echo $sno; ?>" value="<?php echo $rows['id'];?>">
                     ...
                     <td nowrap style="font-size:14px"><?php echo $rows['depname'];?></td>                          

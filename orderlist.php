...
<html
 ...
 <div class="card">
               <div 
                      ...
                      <h5 class="card-title mb-sm-0 me-2" >Order List</h5>
               ...
               &nbsp;  <a class="btn btn-primary add-new " tabindex="0" href="order_confirm.php"
                 type="button" >
                ...
                <div class="card-body">
                  <div class="card-datatable table-responsive">
                    <table class="table table-hover">
                      ...
                      <tbody>
                        <?php
                         ...
                         $sql = " SELECT *,e.id as id FROM order1 e left join partymaster p on e.partyname=p.id ORDER by e.id desc" ;
                    ...
                    <td><div align="center"><?php echo $sno; ?></div></td>                          
                     ...
                     <td>
                          <a href="order_confirm_upd.php?cid=<?php echo base64_encode($rows['id']);?>" type="button" class="btn btn-outline-primary" id="edit<?php echo $sno;?>"><span class="ti-xs ti ti-edit me-1"></span>Edit
                          </a>

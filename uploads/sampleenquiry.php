...
if (isset($_POST['submit'])) {
  ...
  $remarks = $_POST['remarks'];
    ...
    $sql = "INSERT into sampleenq (book,date,sample,fileno,partyname,follow,regard,refno,airway,remarks) values ('$book','$date','$sample','$fileno','$partyname','$follow','$regard','$refno','$airway','$remarks')";
    $result = mysqli_query($conn, $sql);
  
    $sq="select max(id) as id from sampleenq";

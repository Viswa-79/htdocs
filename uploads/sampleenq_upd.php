...
if (isset($_POST['submit'])) {
  ...
  $sql = "UPDATE sampleenq SET book='$book',date='$date',sample='$sample',fileno='$fileno',follow='$follow',regard='$regard',refno='$refno',airway='$airway',remarks='$remarks' WHERE id='$sid'";
  $result = mysqli_query($conn, $sql);
  ...
  foreach ($_POST['itemdesc'] as $key => $val) {
    ...
    $unit = $_POST['unit'][$key];
        ...
        $sql1 = "UPDATE sampleenq1 SET itemdesc='$itemdesc',print='$print',label='$label',quality='$quality',size='$size',quantity='$quantity',unit='$unit' WHERE id='$rid'";

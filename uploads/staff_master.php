                  ...
                  <div class="offcanvas-body mx-0 flex-grow-0 pt-0 h-100">
                    ...
                    <div class="mb-3">
                      ...
                      <label class="form-label"  for="formtabs-country">Department&nbsp;<span style="color:red;">*</span></label>
                              <select id="department" class="form-control" name="department" data-allow-clear="true" required>
                      ...
                      <select id="designation" class="form-control" name="designation" data-allow-clear="true" required>
                                <option value="">Select</option>

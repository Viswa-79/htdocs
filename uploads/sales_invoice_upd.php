        ...
        <div class="layout-page">
		 ...
		 ?>
                    ...
                    <?php } ?>
                          ...
                          <select name="accountname" id="accountname" class="select2 form-select" onchange="get_party_details(this.value);" data-allow-clear="true">
                                <option value="">Select</option>
							<?php 
					$sql = "SELECT * FROM partymaster WHERE party_group='Sales' order by name asc";
                    $result = mysqli_query($conn, $sql);
                    ...
                    <?php } ?>
                          ...
                          <div class="col-md-2">
                            ...
                            <select name="agent" id="agent" class="select2 form-select" onchange="get_party_details(this.value);" data-allow-clear="true">
                                <option value="">Select</option>
							<?php 
					$sql = "SELECT * FROM partymaster WHERE party_group='Sales' order by name asc";
                    $result = mysqli_query($conn, $sql);
                    ...
                    <?php } ?>
                          ...
                          <div class="col-md-2">
                            ...
                            <select name="thirdparty" id="thirdparty" class="select2 form-select" onchange="get_party_details(this.value);" data-allow-clear="true">
                                <option value="">Select</option>
							<?php 
					$sql = "SELECT * FROM partymaster WHERE party_group='Sales' order by name asc";
                    $result = mysqli_query($conn, $sql);
                    ...
                    <?php } ?>
                          ...
                          <input
                              ...
                              id="measurement"
                              name="measurement"
                              value="<?php echo $wz1['measurement']; ?>"
                              class="form-control"
                              placeholder="" />
                          </div>
                ...
                <select name="itemno[]" id="itemno<?php echo $i;?>" onchange="get_item_details(this.id,this.value);" class="select form-select" data-allow-clear="true">
                    <option value="">Select</option>
                    <?php 
              ...
              <div class="col-md-4">
                          ...
                          <div class="col-md-4">
                            ...
                            <input
                              ...
                              value="<?php echo $wz1['delivery_address']; ?>"
                              class="form-control"
                               />
                          </div>
...
if (isset($_POST['submit'])) {
  ...
  foreach ($_POST['itemdesc'] as $key => $val) {
    ...
    if ($balenos != '') {
       $sql1 = "UPDATE salesinvoice1 SET cid='$cid',itemno='$itemno',itemdesc='$itemdesc',balenos='$balenos',quality='$quality',meters='$meters',

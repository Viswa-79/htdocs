...
if (isset($_POST['submit'])) {
  ...
  $remarks = $_POST['remarks'];
   ...
   $sql = "UPDATE purchaseorder SET purchaseno='$purchaseno',date='$date',supplier='$supplier',material='$material',payment='$payment',sales='$sales',orderref='$orderref',orderqty='$orderqty',delivery='$delivery',taxable='$taxable',cgst='$cgst',sgst='$sgst',igst='$igst',round='$round',net='$net',remarks='$remarks' where id='$cid'";
    $result = mysqli_query($conn, $sql);

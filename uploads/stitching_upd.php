                      ...
                      <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div id="order_details" class="content">
                          ...
                          <div class="col-4">
                            ...
                            <select name="tostitch" id="tostitch"  class="select2 form-select" data-allow-clear="true">
...
?>
                        ...
                        <div class="col-4">
                            ...
                            <select name="checking" id="checking" class="select2 form-select" data-allow-clear="true">
                            <option value="">Select</option> 
                          ...
                          <div class="col-2">
                            ...
                            <select name="prepared" id="prepared"  class="select2 form-select" data-allow-clear="true">
                                <option value="">Select</option>
							<?php 
					$sql = "SELECT * FROM staff order by name asc";
                    $result = mysqli_query($conn, $sql);

                      ...
                      <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row g-3">
                          ...
                          <div class="col-md-2">
                            ...
                            <select name="paymentreceived" class="select2 form-control" data-live-search="true"   >
                          ...
                          <label class="form-label" for="collapsible-fullname">Status</label>
                            <select name="dstatus" class="select2 form-control" data-live-search="true"   >
                         ...
                         <option value="">Select</option>
                          ...
                          <label class="form-label">Clearing&nbsp;Agent</label>
                            <select name="clearingagent" id="clearingagent" class="select2 form-select" data-allow-clear="true" >
                            <option value="">Select</option>
							<?php 

				...
				$sql1 = "SELECT * FROM partymaster WHERE party_group='Purchase' order by name asc";
					...
					<?php } ?>
                          ...
                          <div class="col-md-2">
                            ...
                            <select name="material" id="material" class="select2 form-select" data-allow-clear="true" required>
                            <option value="">Select</option>
                                <?php 
...
if (isset($_POST['submit'])) {
  ...
  $remarks = $_POST['remarks'];
    ...
    $sql = "INSERT into purchaseorder (purchaseno,date,supplier,material,payment,sales,orderref,orderqty,delivery,taxable,cgst,sgst,igst,round,net,remarks) values ('$purchaseno','$date','$supplier','$material','$payment','$sales','$orderref','$orderqty','$delivery','$taxable','$cgst','$sgst','$igst','$round','$net','$remarks')";
    $result = mysqli_query($conn, $sql);
  
    $sq="select max(id) as id from purchaseorder";

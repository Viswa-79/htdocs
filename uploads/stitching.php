                      ...
                      <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div id="order_details" class="content">
                          ...
                          <div class="col-4">
                            ...
                            <select name="tostitch" id="tostitch" class="select2 form-select" >
...
<?php
                        ...
                        <div class="col-4">
                          ...
                          <div class="col-2">
                            ...
                            <select name="prepared" id="prepared" class="select2 form-select" >
                                <option value="">Select</option>
							<?php 
					$sql = "SELECT * FROM staff order by name asc";
                    $result = mysqli_query($conn, $sql);
...
if (isset($_POST['submit'])) {
 ...
 values ('$book','$date','$deliverydt','$tostitch','$orderno','$checking','$reorder','$flref','$prepared','$instruction','$remarks','$p1','$p2','$p3','$p4')";
  ...
  $sq="select max(id) as id from stitching";

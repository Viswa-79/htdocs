                  ...
                  <div class="bs-stepper wizard-numbered mt-4">
					...
					<?php } ?>
                          ...
                          <div class="col-md-2">
                            ...
                            <select name="accountname" id="accountname" class="select2 form-select" data-allow-clear="true" >
                                <option value="">Select</option>
                                <?php 
					$sql = "SELECT * FROM partymaster WHERE party_group='Sales' order by name asc";
                    $result = mysqli_query($conn, $sql);
					...
					<?php } ?>
                          ...
                          <div class="col-md-2">
                            ...
                            <select name="agent" id="agent" class="select2 form-select" data-allow-clear="true" >
                                <option value="">Select</option>
                                <?php 
					$sql = "SELECT * FROM partymaster WHERE party_group='Sales' order by name asc";
                    $result = mysqli_query($conn, $sql);
					...
					<?php } ?>
                          ...
                          <div class="col-md-2">
                            ...
                            <select name="thirdparty" id="thirdparty" class="select2 form-select" data-allow-clear="true" >
                                <option value="">Select</option>
                                <?php 
					$sql = "SELECT * FROM partymaster WHERE party_group='Sales' order by name asc";
                    $result = mysqli_query($conn, $sql);
...
if (isset($_POST['submit'])) {
  ...
  $rexno = $_POST['rexno'];
    ...
    $sql = "INSERT into salesinvoice (invoiceno,date,refno,orderdate,orderno,partyname,agent,currency,accountname,thirdparty,measurement,carrier,
    shipmentterms,carriage,vessel,portofloading,portofdischarge,hscode,totalcartons,finaldestination,netwt,grwt,containerno,epcgno,insurance,
    ...
    values ('$invoiceno','$date','$refno','$orderdate','$orderno','$partyname','$agent','$currency','$accountname','$thirdparty','$measurement','$insurance','$carrier',
    '$shipmentterms','$carriage','$vessel','$portofloading','$portofdischarge','$hscode','$totalcartons','$finaldestination','$netwt','$grwt','$containerno','$epcgno',
    '$terms','$delivery_address','$grossamt','$dis','$disamt','$pack','$packamt','$airfreight','$ocharges','$othercharges','$latepayment','$netamt','$freight','$commission','$rexno')";
    $result = mysqli_query($conn, $sql);
  
    $sq="select max(id) as id from salesinvoice";
  ...
  foreach ($_POST['itemdesc'] as $key => $val) {
    ...
    if ($balenos != '') {
       $sql1 = "INSERT into salesinvoice1 (cid,itemno,itemdesc,balenos,quality,meters,rate,amount,netweight,grossweight) 
 values ('$cid','$itemno','$itemdesc','$balenos','$quality','$meters','$rate','$amount','$netweight','$grossweight')";

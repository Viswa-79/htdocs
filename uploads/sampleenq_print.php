...
$sid=base64_decode($_GET['cid']);
   ...
   $sql = " SELECT * FROM sampleenq WHERE id='$sid'";
...
<body>
 ...
 <span class="style5">:&nbsp;&nbsp;&nbsp;<?php echo $so['fileno'];?></span></td>
 </tr>
 ...
 <span class="style5">:&nbsp;&nbsp;&nbsp;<?php echo $so['follow'];?></span></td>
 </tr>
 ...
 <span class="style5"><strong><u>Regarding Inquiry  - <?php echo $so['regard'];?></strong> </span></td>
...
$sql2 = " SELECT * FROM sampleenq1 WHERE cid='$sid'";
...
<?php echo $b3->itemdesc;?></br>
	...
	{ ?>  
	<strong>  ItemNo:</strong><?php echo $b3->itemno;
	  }	?><br>

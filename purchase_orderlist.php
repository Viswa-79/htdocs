              ...
              <div class="card-header d-flex align-items-center justify-content-between">
                     ...
                     <div >
                            <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                              <a type="button" href="purchaseentrylist.php" class="btn btn-primary"> <i class="ti ti-eye me-0 me-sm-1 ti-xs"></i> View GRN
                  ...
                  <div class="card-datatable table-responsive">
                    <table id="myTable" class="table table-hover display">
                      ...
                      <?php
                         ...
                         $sql = " SELECT *,b.id as id FROM purchaseorder b  left join partymaster c on b.supplier=c.id where approve='1' ORDER by b.id desc" ;
                       ...
                       while ($rows=mysqli_fetch_array($result))
                          {
                           $orderno = $rows['purchaseno'];
							
							$b0="SELECT (sum(p.quantity)) as quantity from purchaseorder1  p left join purchaseorder o on p.cid=o.id where purchaseno='$orderno'";
                            $bz=mysqli_query($conn,$b0);
                            $bz1=mysqli_fetch_array($bz);
                            $ord_qty=$bz1['quantity'];

                            $c0="SELECT (sum(pf.quantity)) as quantity from purchaseentry1  pf left join purchaseentry po on pf.cid=po.id where po.pono='$orderno'";
                     ...
                     <td>
                      <span style="width:150px;" class="badge bg-label-<?php echo $clr;?> me-1"><?php echo $status;?></span>
                          ...
                          <td nowrap>
                            <a href="purchaseentry.php?cid=<?php echo base64_encode($rows['id']);?>" 

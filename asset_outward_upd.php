        ...
        <div class="layout-page">
		 ...
		 ?>
              ...
              <div class="card-header d-flex align-items-center justify-content-between">
                      ...
                      <a href="asset_outward_list.php"
                          type="button" class="btn btn-outline-warning" >
                            <span class="ti-xs ti ti-eye me-1"></span>View Asset Outward 
                          </a>
                    </div>  <br>         
              ...
              <div class="card mb-2 mt-2" >
                <form class="card-body"action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="bs-stepper-content">
                      <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <?php
                              $sql4 = " SELECT * FROM asset_outward WHERE id='$sid'";
                    ...
                    <?php } ?>                                        
                        ...
                        <div class="table-responsive">
                            <table class="table table-border  table-hover mt-2">
                              ...
                              <?php
                        $sno=1; $i=0;
                              $sql4 = " SELECT * FROM asset_outward1 Where cid='$sid'";
                              $result4 = mysqli_query($conn, $sql4);
                ...
                <td style="padding: 0.3rem;width: 230px;">
                <select name="ass_name[]"  id="ass_name<?php echo $i;?>" class="select form-select" onchange="asset(this.id,this.value);"  >
                                  <option value="">Select</option>
                                   <?php 
...
<input type="text" hidden class="form-control form-control-lg" name="rc[]" id="rc" value="<?php echo $i;?>">
              ...
              <div class="mb-0"><hr></div>
                          ...
                          <a class="btn btn-label-dark btn-prev" href="asset_outward_list.php">
...
if (isset($_POST['submit'])) {
  ...
  $remarks = $_POST['remarks'];
   ...
   $sql = "UPDATE asset_outward SET dc_no='$dc_no',date='$date',supplier='$supplier',remarks='$remarks' where id='$cid'";
    $result = mysqli_query($conn, $sql);
  ...
  foreach ($_POST['ass_grp'] as $key => $val) {
    ...
    $gstamount = $_POST['gstamount'][$key];
     ...
     $sql1 = "UPDATE asset_outward1 SET ass_grp='$ass_grp', ass_name='$ass_name',ass_no='$ass_no',warrant='$warrant',remark='$remark' where id='$rid'";
  ...
  if ($result1) {
    ...
    Swal.fire({
      title: "Updated!",
      text: " Asset outward Updated successfully.",
      icon: "success",

                       ...
                       for ($i = 1, $sno = 2; $i < 20; $i++, $sno++) {
                         ...
                         <form action="" method="post" autocomplete="off" enctype="multipart/form-data" >
                          <tr id="addimage<?php echo $i;?>" style="display:none">
                                  ...
                                  <input hidden type="text" name="img_id" id="img_id<?php echo $i;?>" class="form-control" value="1" 
                                  aria-label="Product barcode"/>
                                  <input  type="text" name="img_name" id="img_name<?php echo $i;?>" class="form-control" value="<?php echo "Remark Image".' '.$sno;?>" />
                                  </td>
                                  <td>
                                  <input type="text"  style="text-align:center" readonly name="sno" id="sno<?php echo $i;?>" class="form-control" value="<?php echo $sno;?>">
                              </td>
                    ...
                    while($rw3 = mysqli_fetch_array($result3))
                     {
                      ...
                      $sts = $rw3['status'];
                                ...
                                <td hidden>
                                  ...
                                  aria-label="Product barcode"/>
      <input hidden type="text" name="img_name" id="img_name<?php echo $i;?>" class="form-control" value="<?php echo "Workmanship Image".' '.$sno;?>" />
                    ...
                    while($rw4 = mysqli_fetch_array($result4))
                     {
                      ...
                      $status1 = $rw4['status'];
                                ...
                                <input type="text" hidden id="rid<?php echo $i;?>" name="rid" value="<?php echo $rw4['id'];?>" /> 
                                  ...
                                  aria-label="Product barcode"/>
      <input hidden type="text" name="img_name" id="img_name<?php echo $i;?>" class="form-control" value="<?php echo "Packing Image".' '.$sno;?>" />
                    ...
                    while($rw5 = mysqli_fetch_array($result5))
                     {
                      ...
                      $sts1 = $rw5['status'];
                                ...
                                <td hidden>
                                  ...
                                  aria-label="Product barcode"/>
      <input hidden type="text" name="img_name" id="img_name<?php echo $i;?>" class="form-control" value="<?php echo "Barcode Image".' '.$sno;?>" />
                    ...
                    while($rw6 = mysqli_fetch_array($result6))
                     {
                      ...
                      $sts = $rw6['status'];
                                ...
                                <td hidden style="padding: 0.3rem;text-align:center">
                                  ...
                                  <input hidden type="text" name="img_name" id="img_name<?php echo $i;?>" class="form-control" value="<?php echo "Onsite Image".' '.$sno;?>" />
                              </td>
                              <td style="width:100px;text-align:center">
                                  <input type="text" style="text-align:center" readonly name="sno" id="sno<?php echo $i;?>" class="form-control" value="<?php echo $no;?>">
                              </td>
        ...
        <a  href="uploads/<?php echo $rw6['defimg']; ?>" target="blank"
          ...
          <td >
              ...
              <div class="col-md-12 mb-8 card card-body">
                       <div style=" text-align:center;padding:15px">
                  <span style="font-size:16px;font-family:table-icons;" class="btn btn-outline-primary"> Client Requirement Image</span>
                        </div>
                      <div class=" table-responsive">
                            <table class="table table-border table-hover">
                              <thead class="border-bottom border-top" >
                              ...
                              $i = 500;
                              $sno = 1;
                $sql6 = "SELECT * FROM wm_record_img where cid='$sid' and img_id=10 order by id asc";
                    $result6 = mysqli_query($conn, $sql6);
                    $count6 = mysqli_num_rows($result6);
                    if($count6 > 0){
                    while($rw6 = mysqli_fetch_array($result6))
                     {
                      ...
                      $sts = $rw6['status'];
                                ...
                                <td hidden style="padding: 0.3rem;text-align:center">
                                  <input type="text" hidden  class="form-control" id="img_id<?php echo $i;?>" name="img_id" value="10">
                                  <input hidden type="text" name="img_name" id="img_name<?php echo $i;?>" class="form-control" value="<?php echo "Client Image".' '.$sno;?>" />
        ...
        <a  href="uploads/<?php echo $rw6['defimg']; ?>" target="blank"
          ...
          $j = $i;
             for ($i = $j, $sno = $no; $i < 520; $i++, $sno++) {
          ?>
                                <tr id="addimage<?php echo $i;?>" style="display:none" >
                              
                                <td hidden>
                                  <input hidden type="text" class="form-control" id="img_id<?php echo $i;?>" name="img_id" value="10">
                              </td>
                              <td style="width:100px;text-align:center">
                                  <input type="text" style="text-align:center" readonly name="sno" id="sno<?php echo $i;?>" class="form-control" value="<?php echo $sno;?>">
                              </td>
            ...
            <?php
                          ...
                          ?>
                           <form action="" method="post" autocomplete="off" enctype="multipart/form-data" >
                             <tr >
                                <td hidden>
                                  <input hidden type="text" name="img_id" id="img_id<?php echo $i;?>" class="form-control" value="10" 
                                  aria-label="Product barcode"/>
           <input hidden type="text" name="img_name" id="img_name<?php echo $i;?>" class="form-control" value="<?php echo "Client Image".' '.$sno;?>" />
          ...
          <td >
             ...
             ?> 
                                ...
                                <td hidden>
                                  ...
                                  <input hidden type="text" name="img_name" id="img_name<?php echo $i;?>" class="form-control" value="<?php echo "Ref-Sample Image".' '.$sno;?>" />
...
<input hidden type="text" name="img_name" id="img_name<?php echo $i;?>" class="form-control" value="<?php echo "General Image".' '.$sno;?>" />
                              </td>
                              <td style="width:100px;text-align:center">
                                  <input type="text" style="text-align:center" readonly name="sno" id="sno<?php echo $i;?>" class="form-control" value="<?php echo $no;?>">
                              </td>
                    ...
                    while($rw9 = mysqli_fetch_array($result9))
                     {
                      ...
                      $status = $rw9['status'];
                                ...
                                <td hidden>
                                  ...
                                  <input hidden type="text" name="img_name" id="img_name<?php echo $i;?>" class="form-control" value="<?php echo "PO sheet Image".' '.$sno;?>" />
                              </td>
                              <td style="width:100px;text-align:center">
                                  <input type="text" style="text-align:center" readonly name="sno" id="sno<?php echo $i;?>" class="form-control" value="<?php echo $no;?>">
                              </td>
                    ...
                    while($rw10 = mysqli_fetch_array($result10))
                     {
                      ...
                      $status = $rw10['status'];
                                ...
                                <td hidden>
                                  ...
                                  <input hidden type="text" name="img_name" id="img_name<?php echo $i;?>" class="form-control" value="<?php echo "COC Image".' '.$sno;?>" />
                              </td>
                              <td style="width:100px;text-align:center">
                                  <input type="text" style="text-align:center" readonly name="sno" id="sno<?php echo $i;?>" class="form-control" value="<?php echo $no;?>">
                              </td>

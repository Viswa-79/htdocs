        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            <div class="container-xxl flex-grow-1 container-p-y"> 
              ...
              <h3> <button class="btn btn-label-primary">Profile Details</button></h3>
              <span>
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-2 col-md-3">
                            ...
                            <select id="userrole" name="userrole" class="form-select" onchange="get_id(this.value)" required autofocus>
                              <option value="">Select </option>
                              <?php 

...
const myFunction = () => {
 ...
 ?>
          ...
          <button class="btn btn-label-primary waves-effect">Expense Claim Report</button>
        ...
        <thead style="text-align:center;font-weight:bold">
                  ...
                  <th  style="text-align:center" nowrap><b>Expense Date</b></th>
				  <th  style="text-align:center" nowrap><b>Expense Type</b></th>
          ...
          <th  style="text-align:center" nowrap><b>Status</b></th>
            ...
            $status=$_REQUEST['status'];
                ...
                $clr='';
             $tott=0;
         $sql4 = "SELECT *,h.id as id,h.status as status From  exp_claim  h left join employee e  on h.staff=e.id left join expense d on h.exp_type=d.id   where h.date between '$fromdate' and '$todate' $rr order by h.id asc";
    ...
    $result4 = mysqli_query($conn, $sql4);
            ...
            ?>
               ...
               <td style="text-align:left;text-transform:uppercase"><b style="font-size:14px"><?php echo $wz1['expense_name']; ?></b></td>           
...
<a href="exp_claim_report.php" class="btn btn-primary mt-4"><i class="ti ti-arrow-left me-sm-1 me-0"></i>Back</a>

          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card-header d-flex align-items-center justify-content-between">
                      ...
                      <button class="btn btn-warning">Quotation Report </button>
                     
                    </div>  <br>         
                                <div class="card mb-2 mt-2">
                   
                      <form class="card-body" action="quote_report1.php" method="post" enctype="multipart/form-data">
					...
					<?php } ?>
                          ...
                          <!-- <div class="col-md-3">
                            <label class="form-label" for="collapsible-fullname">Inspection&nbsp;Type&nbsp;<span style="color:red;">*</span></label>
                            <select name="ins_type" id="ins_type" class="select form-select" data-allow-clear="true" >
                                <option value="">Select</option>
                                <?php 
					// $sql = "SELECT * FROM inspect_type order by id asc";
          //           $result = mysqli_query($conn, $sql);
          //           while($rw = mysqli_fetch_array($result))
					// { ?>
                         <option value="/* echo $rw['id'];?>">echo $rw['type'];*/
						 </option>
					<?php// } ?>
                              </select>
                          </div> -->

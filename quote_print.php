...
error_reporting(0);
	...
	$sid=base64_decode($_REQUEST['cid']);
		...
		if($sid=='')
{
$s1="SELECT * FROM quote order by id desc";
...
<table align="center" width="852" style="border:none; page-break-before:always;">
  ...
  <tr style="border:none;">
    <td  width="709" height="25" style="border:none;"><div style="margin-left:45%"><strong style="font-size:22px;">QUOTATION</strong></div></td>
  </tr>
</table>
  ...
  $wz=mysqli_query($conn,"select * from quote where id='$sid'");
$wz1=mysqli_fetch_array($wz);
$refno=$wz1['qno'];
// $date=$wz1['date'];
$dcno=$wz1['quote_no'];
...
<table width="850" style="border: 1px solid black;border-collapse: collapse;border-color:#999;"  align="center">
 ...
 <strong>Email : <?php echo $rz2['emailid'];?></strong>
    ...
    <td height="38" colspan="2" style="border: 1px solid black;border-collapse: collapse;border-color:#999; border-left: 2px solid black; border-bottom: 1px solid #999;border-collapse: collapse; border-top: 2px solid black;border-collapse: collapse;" ><strong>&nbsp;Party Name :-</strong>
	  ...
	  <td width="183" height="38" style="border: 1px solid thin black;border-collapse: collapse; border-color:#999;border-top: 2px solid black;border-collapse: collapse;border-right:none;"><strong style="font-size:18;padding-left:5px;">Quotation No</strong><strong style="font-size:18;"></strong></td>
...
<div style="margin-left:15%;margin-top:2%">
        <?php  
$a0="SELECT * FROM quote e left join partymaster a on e.partyname=a.id where e.id='$sid'";
//echo $a0;
...
<strong >GST NO : </strong><?php echo $r1['gstno'];?> <br>
    ...
    <td height="28" style="border: 1px solid thin black;border-collapse: collapse;border-color:#999;border-right:none;padding-left:5px;FONT-SIZE:16px"><strong>Quotation Date</strong></td>
  ...
  <tr style="border: 1px solid black;border-collapse: collapse;border-color:#999;">
    <td height="33" style="border: 1px solid black;border-collapse: collapse;border-color:#999;border-right:none;padding-left:5px;" ><strong>PO No</strong></td>
    ...
    <td style="border: 1px solid black;border-collapse: collapse;border-color:#999;border-right: 2px solid black;border-left:none;"><?php echo $pono;?></td>
  </tr>
  <tr style="border: none;">
...
<table  width="850"  align="center" style="border: 1.5px solid black;border-collapse: collapse;font-size:16px">
  <tr align="center" style="font-weight:bold;border-collapse: collapse;background-color:#<?php echo $color;?>;color:#<?php echo $font_color;?>;">
    ...
    <td  style="border: 1px solid black;border-top: 2px solid black;border-collapse: collapse; border-right: 1px solid black;border-bottom: 2px solid black ;border-left: 1px solid black">Factory Name</td>
    <td  style="border: 1px solid black;border-top: 2px solid black;border-collapse: collapse; border-right: 1px solid black;border-bottom: 2px solid black ;border-left: 1px solid black">Style No</td>
    <td  style="border: 1px solid black;border-top: 2px solid black;border-collapse: collapse;border-right: 1px solid black;border-bottom: 2px solid black ;border-left: 1px solid black; ">Size</td>
    ...
    <td   style="border: 1px solid black;border-top: 2px solid black;border-collapse: collapse;border-right: 1px solid black;border-bottom: 2px solid black ;border-left: 1px solid black; ">Manday</td>
    <td   style="border: 1px solid black;border-top: 2px solid black;border-collapse: collapse;border-right: 1px solid black;border-bottom: 2px solid black ;border-left: 1px solid black; ">Charges</td>
    <td   style="border: 1px solid black;border-top: 2px solid black;border-collapse: collapse;border-right: 1px solid black;border-bottom: 2px solid black ;border-left: 1px solid black; ">Gst (%)</td>
  <td   style="border: 1px solid black;border-top: 2px solid black;border-collapse: collapse;border-right: 2px solid black;border-bottom: 2px solid black ;border-left: 1px solid black; ">Final Amnt</td>

</tr>
  <?php

		   $sno=1;$i=0;$j=0;
 $sql = "SELECT * FROM quote1 m left join assignment n on m.companyname=n.id where cid='$sid' order by m.id asc";
...
while($row = mysqli_fetch_array($result))
{
  ...
  <tr style="border-bottom:none;border-collapse: collapse;font-size:14px;">
   ...
   border-right: 1px solid #999;"><div align="center"><?php echo $sno;?> </div></td>
    <td height=""  align="left"style="border-top:none;border-bottom:none;border-right: 1px solid #999;border-left: 1px solid #999;   border-collapse: 2px solid black;border-bottom: collapse; padding-left:5px;"><?php echo $row['name'];?> </td>
    <td height=""  align="center"style="border-top:none;border-bottom:none;border-right: 1px solid #999;border-left: 1px solid #999;   border-collapse: 2px solid black;border-bottom: collapse; padding-left:5px;"><?php echo $row['styleno'];?> </td>
    <td height=""  align="center" style="border-top:none;border-bottom:none;border-right: 1px solid #999;border-left: 1px solid #999; border-collapse: 2px solid black;border-bottom: collapse;padding-right:5px;"><?php echo $row['size']; ?></td>
    <td height=""  align="right" style="border-top:none;border-bottom:none;border-right: 1px solid #999;border-left: 1px solid #999; border-collapse: 2px solid black;border-bottom: collapse;padding-right:5px;"><?php echo $row['quantity']; ?></td>
    ...
    <td height=""  align="right" style="border-top:none;border-bottom:none;border-right: 1px solid #999;border-left: 1px solid #999; border-collapse: 2px solid black;border-bottom: collapse;padding-right:5px;"><?php echo $row['gst']; ?></td>
    <td height=""  align="right" style="border-top:none;border-bottom:none;border-right: 2px solid black;border-left: 1px solid #999; border-collapse: 2px solid black;border-bottom: collapse;padding-right:5px;"><?php echo $row['finamnt']; ?></td>
  </tr>
  <?php
...
{	  
  ...
  <tr  style="border-top: 1px solid black;" height="35">
 
	
      <td  style="border-left:2px solid black;" colspan="6" ><div align="right"><strong>Net Amount&nbsp;</strong></div></td>
	  <td  style="border-right:1px solid black;" ><div align="center"><strong><?php echo $tman; ?></strong></div></td>
	  <td  style="border-right:1px solid black;" ><div align="right"><strong><?php echo ''; ?></strong></div></td>
	  <!-- <td  style="border-right:1px solid black;" ><div align="right"><strong><?php echo ''; ?></strong></div></td> -->
	  <td  style="border-right:1px solid black;" ><div align="right"><strong><?php echo ''; ?></strong></div></td>
	  <td  style="border-right:2px solid black;" ><div align="right"><strong><?php echo number_format((float)$tfinal, 2, '.', ''); ?></strong></div></td>
    </tr>
</table>


<table width="850" height="50" style="border: 1px solid black;border-collapse: collapse;border-color:#999;"  align="center"> 
 
<tr >
 <td height="" colspan="5" rowspan="6" align="left" style="border-bottom:none;border-top:1px solid black;border-left: 2px solid black;border-right: 2px solid black;border-collapse: collapse;border-top:none;padding-right:5px;vertical-align:top;"><strong>Amount in Words (Rupees) :<br />

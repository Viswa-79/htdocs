          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card-header d-flex align-items-center justify-content-between">
                      <button class="btn btn-success">Asset Inward List</button><br>
                      ...
                      <div >
                            <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                              <a type="button" href="asset_inward.php" class="btn btn-primary"> <i class="ti ti-plus me-0 me-sm-1 ti-xs"></i> Add New
                  ...
                  <div class="card-datatable table-responsive">
                    <table id="myTable" class="table table-hover display">
                      ...
                      <?php
                         ...
                         $sql = " SELECT *,b.id as id FROM asset_inward b left join partymaster c on b.supplier=c.id ORDER by b.id desc" ;
                     ...
                     <td><?php echo $rows['name'];?></td>                          
                          ...
                          <a href="asset_inward_upd.php?cid=<?php echo base64_encode($rows['id']);?>" 
        ...
        if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
          ...
          if (data.sts == 'ok') {
            ...
            Swal.fire('Deleted!', 'Your file has been deleted.', 'success').then(() => {
              window.location = 'asset_inward_list.php';
            });
          }
        }
      };
      xmlhttp.open("GET", "ajax/del_asset_inward.php?id=" + user_id, true);
      xmlhttp.send();
    }
  });
}

          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card-header d-flex align-items-center justify-content-between mt-4">
                      ...
                      <button class="btn btn-label-primary">Login Report</button>
                     
                    </div>  <br>         
                                <div class="card mb-2 mt-2">
                   
                      <form class="card-body" action="login_report1.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row g-3">
                          ...
                          <div class="col-md-3">
                            <label class="form-label" for="collapsible-fullname">Staff ID&nbsp;<span style="color:red;">*</span></label>
                            <select
                              id="empid"
                              name="empid"
                              class="form-select"
					...
					{ ?>
                         <option value="<?php echo $rw['id'];?>"><?php echo $rw['empid'];?>
						 </option>
					<?php } ?>
                          </select>
                          </div>

                        ...
                        <div class="row">
                            <div class="col-12 mb-4">
                                <div class="card-header d-flex align-items-center justify-content-between">
                                    <button class="btn btn-success">Expense&nbsp;Claim</button>
                                    <a href="exp_approve.php" class="btn btn-outline-warning">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            for ($i = 0, $sno = 1; $i < 1; $i++, $sno++) {
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="padding: 0.3rem">
                                                                        <select name="staff[]" id="staff<?php echo $i; ?>" class="select form-select" required>
                                                                            ...
                                                                            while ($rw = mysqli_fetch_array($result)) {
                                                                                ?>
                                                                                <option value="<?php echo $rw['id']; ?>"><?php echo $rw['name']; ?>-<?php echo $rw['depname']; ?></option>
                                                                                <?php
                                                                            }
                                                                            ?>
                                                                        </select>
                                                                    ...
                                                                    <td style="padding: 0.3rem">
                                                                        <select id="status<?php echo $i; ?>" name="status[]" class="select form-select">
                                                            ...
                                                            for ($i = 1, $sno = 2; $i <= 20; $i++, $sno++) {
                                                                ...
                                                                <tr id="s1<?php echo $i; ?>" style="display:none">
                                                                    ...
                                                                    <td style="padding: 0.3rem">
                                                                        <select name="staff[]" id="staff<?php echo $i; ?>" class="select form-select">
                                                                            <option value="">Select</option>
                                                                            <?php
...
if (isset($_POST['submit'])) {
    foreach ($_POST['staff'] as $key => $val) {
        ...
        if ($staff != '') {
            ...
            $sql1 = "INSERT INTO exp_claim(staff, exp_type, date, applydate, amount, remarks, status) VALUES ('$staff', '$exp_type', '$date', '$applydate', '$amount', '$remarks', '$status')";
    ...
    if ($result1) {
        echo "<script>alert('Entry successfully'); window.location='exp_approve.php';</script>";
    } else {

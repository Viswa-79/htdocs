          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card-header d-flex align-items-center justify-content-between">
                      ...
                      <button class="btn btn-warning">Purchase Order Report </button>
                     
                    </div>  <br>         
                                <div class="card mb-2 mt-2">
                   
                      <form class="card-body" action="pur_ord_report1.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row g-3">
                          ...
                          <div class="col-md-3">
                            ...
                            <option value="">Select</option>
                             <?php 
			             	$sql11 = "SELECT * FROM partymaster order by name asc ";
                                $result11 = mysqli_query($conn, $sql11);
                                while($rw11 = mysqli_fetch_array($result11))
			             	{ ?>
                                     <option value="<?php echo $rw11['name'];?>"><?php echo $rw11['name'];?>
			             		 </option>
			             	<?php } ?>
                                        </select>
                                      </div>

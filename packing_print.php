...
$sid=base64_decode($_GET['cid']);
 ...
 $sql = " SELECT * FROM packing WHERE id='$sid'";
...
<body>
  ...
  <table width="878"  align="center" style="border-collapse:collapse; border:none;">
   ...
   <table width="878"  align="center" style="border:none;">
	  ...
	  To:<?php echo $ad['companyname'];?> Packing Unit
	  </br></br>
	  Kind Attn : <?php echo $so['to1'];?>
	   </br></br>
 ...
 <span class="style5">:&nbsp;&nbsp;&nbsp;<?php echo $so1['orderno'];?> / <?php echo $so1['pono'];?></span>
</td>
...
$i=1;
    ...
    $b1="SELECT * from packing1 where cid='$sid' ";
  ...
  <tr style="border-bottom:1px solid black;" >
	 ...
	 <?php if($so1->itemno!='' && $so1->itemno!='-')
	{ ?> Item no: </strong><?php echo $so1->itemno;?>/<?php } ?>
	<?php 
	  if($so1->pono!='' && $so1->pono!='-'){
	  echo $so1->pono; }?></strong></br><strong>Description :</strong>&nbsp;<?php echo $so1->itemdesc;?></br>
	<?php if($so1->print!='' && $so1->print!='-')
	{ ?>  
	<strong>  Print :</strong>&nbsp;<?php echo $so1->print;
	  }	?> </div></td>

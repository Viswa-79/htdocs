      ...
      <div class="layout-container">
        ...
        <div class="layout-page">
         ...
         <?php include "header.php"; ?>
          ...
          <h3> <button class="btn btn-success"> Relieve </button></h3>
                     
                    
                                  <a class="btn btn-primary float-end btn-group" style="color:white"  data-bs-toggle="modal" data-bs-target="#editUser" tabindex="0"  ><i style="color: white;" class="ti ti-plus me-0 me-sm-1 ti-xs"></i>Apply Relieve</a>
</div>         
   <!-- Teams Cards -->
   <div class=" row g-4">
   ...
   <div class="col-xl-12 col-lg-6 col-md-6">
                 <div class="card">
                  ...
                  <div  class="card-datatable table-responsive">
                    <table id="myTable" class="table table-hover display">
                      <thead>
                        <tr>
                          ...
                          <th  style="text-align:center">Relieve&nbsp;On</th>
                   ...
                   $sql = " SELECT *,a.id as id FROM  relieve a left join employee b on a.staffname=b.id left join depart c on b.depart=c.id left join desi_master d on b.desig=d.id where b.status!='1' group by a.staffname order by a.id desc";
                  ...
                  ?>
                     <input type="text" hidden name="id[]" id="id<?php echo $sno; ?>" value="<?php echo $rows['id'];?>">
                      ...
                      <td style="text-align:center"><?php echo $rows['depname'];?></td>
                      <td style="text-align:center"><?php echo $rows['desig'];?></td>
                  ...
                  <div class="modal-content p-3 p-md-2">
                    <div class="modal-body">
                      ...
                      <div class="text-center mb-4">
                        ...
                        <h3 class="mb-2">Relieve Application</h3>
                        <p class="text-muted">create a Relieve request </p>
                      </div>
                      ...
                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        ...
                        <div class="col-12">
                          ...
                          <?php 
				echo	$sql = "SELECT *,e.id as id  FROM employee e left join depart d on e.depart=d.id where e.status='1' order by e.id asc";
                    $result = mysqli_query($conn, $sql);
...
//$leave_remain=$monthleave-$nod;
    ...
    $sql="insert into relieve (staffname,date,reason)values('$staffname','$date','$reason')"; 
$result1=mysqli_query($conn, $sql);



 $sql1="UPDATE employee SET status='2' WHERE id='$staffname'";
...
if ($result1) {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      window.location.href = "relieve.php"; // Corrected line
    }
  });
</script>';
} 

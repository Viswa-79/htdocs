...
$query = "SELECT *,m.role as role,s.id as id FROM employee s left join user_role m on s.userrole=m.id WHERE s.id = '$user_id'";
$result = mysqli_query($conn, $query);
$rz1=mysqli_fetch_array($result);
$user_role=$rz1['userrole'];
$role=$rz1['role'];
$imageupload=$rz1['imageUpload'];
$user_name=$rz1['name'];
$uid=$rz1['id'];
$email=$rz1['email'];
$mods = $rz1['module'];
...
<head>
  ...
  <link rel="stylesheet" href="../assets/vendor/libs/animate-css/animate.css" />
    ...
    <!-- Core CSS -->
    <link rel="stylesheet" href="../assets/vendor/css/rtl/core.css" class="template-customizer-core-css" />
    <link href="../../assets/vendor/css/rtl/theme-semi-dark.css" rel="stylesheet" type="text/css" class="template-customizer-theme-css">
    <link rel="stylesheet" href="../assets/css/demo.css" />

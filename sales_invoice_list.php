          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card-header d-flex align-items-center justify-content-between">
                      <button class="btn btn-success">SALES INVOICE LIST</button><br>
                     ...
                     <div >
                            <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                              <a type="button" href="saleslist.php" class="btn btn-primary"> <i class="ti ti-plus me-0 me-sm-1 ti-xs"></i> Add New
                  ...
                  <div class="card-datatable  table-responsive">
                    ...
                    $row = mysqli_fetch_array($result1);
                     ...
                     $delete_permit = $row['delete_access'];
                         ...
                         $sql = " SELECT *,e.id as id FROM sales_invoice e left join partymaster n on e.partyname=n.id ORDER by e.id desc";
                    ...
                    <input type="text" hidden name="cid[]" id="cid<?php echo $sno; ?>" value="<?php echo $rows['id'];?>">
                     ...
                     <td style="text-align:center"><?php echo $rows['invoiceno'];?></td>                         
                     <td nowrap><?php echo date('d-m-Y',strtotime($rows['date'])); ?></td>                     
                     <td><?php echo $rows['name'];?></td>                         
                                      
                                                
                          <td nowrap>
                            <a href="salesinvoice_print.php?cid=<?php echo base64_encode($rows['id']);?>" 
                          ...
                          <?php } if ($delete_permit==1){ ?>                          
                            <a  href="ajax/delsales.php?cid=<?php echo base64_encode($rows['id']);?>"

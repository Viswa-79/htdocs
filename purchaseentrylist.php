          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card-header d-flex align-items-center justify-content-between">
                      <button class="btn btn-success">GRN LIST</button><br>
                     ...
                     <div >
                            <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                              <a type="button" href="purchase_orderlist.php" class="btn btn-primary"> <span class="ti-xs ti ti-plus me-1"></span>Generate New
                  ...
                  <div class="card-datatable table-responsive">
                    ...
                    $row = mysqli_fetch_array($result1);
                     ...
                     $delete_permit = $row['delete_access'];
                         ...
                         $sql = " SELECT *,m.id as id FROM purchaseentry m left join partymaster n on m.supplier=n.id ORDER by m.id desc" ;
                    ...
                    <input type="text" hidden name="cid[]" id="cid<?php echo $sno; ?>" value="<?php echo $rows['id'];?>">
                     ...
                     <td><?php echo $rows['name'];?></td>                          
                          ...
                          <?php }else{?>
                          <button disabled style="width:113px" class="btn btn-outline-primary" id="edit<?php echo $sno;?>">
                            <span class="ti-xs ti ti-edit me-1"></span>View/Edit
                          </button>
                          <?php } ?>

                            <button   <?php  if($delete_permit==0){ echo "disabled"; } ?> href="ajax/delpurchaseentry.php?cid=<?php echo base64_encode($rows['id']);?>"

...
const myFunction = () => {
 ...
 ?>
        ...
        <thead style="text-align:center;font-weight:bold">
                  ...
                  <th  style="text-align:center"nowrap><b>Applied On</b></th>
                  <th  style="text-align:center" nowrap><b>Leave Date</b></th>
				  <th  style="text-align:center" nowrap><b>Leave Type</b></th>
          <th  style="text-align:center" nowrap><b>Paid Leave</b></th>
          <th  style="text-align:center" nowrap><b>Unpaid Leave</b></th>
          <th  style="text-align:center" nowrap><b>Status</b></th>
            ...
            $status=$_REQUEST['status'];
                    ...
                    $aa=array('h.staff'=>$staffname,'h.status'=>$status);
                    $aa=array_filter($aa);
                ...
                $clr='';
             $tott=0;
     $sql4 = "SELECT *,h.id as id,h.status as status From  leave_req  h left join employee e  on h.staff=e.id left join leave_type d on h.leavetype=d.id   where h.applydate between '$fromdate' and '$todate' $rr order by h.id asc";
    ...
    $result4 = mysqli_query($conn, $sql4);
            ...
            ?>
               ...
               <td style="text-align:center"  nowrap><?php echo date('d-m-Y',strtotime($wz1['applydate']));?></td>           
               <td style="text-align:center"  nowrap><?php echo date('d-m-Y',strtotime($wz1['fdate']));?>-<?php echo date('d-m-Y',strtotime($wz1['todate']));?></td>           
               <td style="text-align:left;text-transform:uppercase"><b style="font-size:14px"><?php echo $wz1['leavename']; ?></b></td>           
               <td style="text-align:center"  nowrap><?php echo $tot; ?></td>           
               <td style="text-align:center"  nowrap><?php echo $tot1; ?></td>           
               
               <td style="text-align:center"><?php echo $wz1['status']; ?></td>           
             ...
             <?php $sno++;
         $tott+=number_format((float)$tot);
         $tott1+=number_format((float)$tot1);
...
<tr style="font-weight:bold;font-size:17px">
             ...
             <td style="text-align:center"><?php echo number_format((float)$tott); ?></td>
             <td style="text-align:center"><?php echo number_format((float)$tott1); ?></td>
            <td></td>
          </tr>
...
<a href="leave_report.php" class="btn btn-primary mt-4"><i class="ti ti-arrow-left me-sm-1 me-0"></i>Back</a>
